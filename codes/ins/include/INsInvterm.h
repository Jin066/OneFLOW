...
public:
	...
	RealField bc, spj, aji, Vdv, spp,  ajp, app, spu1, spv1, spw1, spu2, spv2, spw2, sp1, sp2, bm, buc, bvc, bwc, f1, f2, dist, Vdvu, Vdvv, Vdvw, aju, ajv, ajw, VdU, VdV, VdW,bpu, bpv, bpw, sppu, sppv, sppw, uuj, vvj, wwj, pp1, pp2, uu, vv, ww, ai1, ai2, l2rdx, l2rdy, l2rdz, Fn, Ft;
...
public:
	...
	Real vnrel, Vau, Vav, Vaw, pp, fq0, clr, crl, vnflow;// l2rdx, l2rdy, l2rdz, Fn, Ft;
    Real cl, cr, cm;
public:
