...
public:
	...
	RealField bc, spj, aji,aju,ajv,ajw, bpu, bpv, bpw, Vdv,VdU, VdV, VdW, spp, sppu, sppv, sppw,  ajp, app;
...
public:
	...
	Real vnrel, vnflow, fq0, clr, crl, ai1, ai2, spu1, spv1, spw1, spu2, spv2, spw2, sp1, sp2, bm, buc, bvc, bwc, Vau, Vav, Vaw ,f1, f2,dist ,Vdvu, Vdvv, Vdvw;
    Real cl, cr, cm;
public:
