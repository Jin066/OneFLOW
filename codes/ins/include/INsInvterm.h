...
public:
	...
	RealField bc, spj, aji, Vdv, spp,  ajp, app, spu1, spv1, spw1, spu2, spv2, spw2, sp1, sp2, bm, buc, bvc, bwc, f1, f2, dist;
...
public:
	...
	Real vnrel, vnflow, fq0, clr, crl, ai1, ai2, Vau, Vav, Vaw, Vdvu, Vdvv, Vdvw, aju, ajv, ajw, VdU, VdV, VdW, bpu, bpv, bpw, sppu, sppv, sppw, pp, uu, vv, ww, uuj, vvj, wwj, pp1, pp2;
    Real cl, cr, cm;
public:
