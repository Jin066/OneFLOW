...
public:
	...
	RealField  ai1, ai2, bm, buc, bvc, bwc, bc,sp, sp1, sp2, spj, spu,spv,spw,fq0, aji,aju,ajv,ajw, Vdv, Vdvu, Vdvv, Vdvw, VdU, VdV, VdW, bpu, bpv, bpw, spp, sppu, sppv, sppw, dist, f1, f2, ajp, app;
