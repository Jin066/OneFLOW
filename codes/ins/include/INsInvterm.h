...
public:
	...
	RealField pp1,pp2,uu, vv, ww, uuj, vvj, wwj;//单元修正的压力和速度变量、界面修正速度变量
public:
	...
	Real vnrel, vnflow, fq0, clr, crl, ai1, ai2, spu1, spv1, spw1, spu2, spv2, spw2, sp1, sp2, bm, buc, bvc, bwc, Vau, Vav, Vaw ,f1, f2,dist ,Vdvu, Vdvv, Vdvw, aju, ajv, ajw, VdU, VdV, VdW, bpu, bpv, bpw, sppu, sppv, sppw, pp;
    Real cl, cr, cm;
public:
